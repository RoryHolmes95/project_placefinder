...
def get_union(auth_key=key):
    ...
    ax.plot(df3.longitude, df3.latitude)
    ...
    #plt.fill_between(coords.longitude, coords.latitude, color='blue', alpha = 0.2)
    #plt.fill_between(coords2.longitude, coords2.latitude, color='orange', alpha = 0.2)
    plt.fill_between(df3.longitude, df3.latitude, color='green', alpha = 0.4)
    plt.show()
